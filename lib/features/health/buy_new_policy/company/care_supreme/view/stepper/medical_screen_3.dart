...
import '../../viewmodel/medical_3_viewmodel.dart';

class CareSupremeMedicalScreen3 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
      create: (context) => CareSupremeMedical3ViewModel(),
      child: Scaffold(
        appBar: AppBar(
        ...
        body: Consumer<CareSupremeMedical3ViewModel>(
              ...
              Expanded(
                child: ElevatedButton(
                  onPressed: () {
                    Navigator.pushNamed(
                      context,
                      RouteNames.careSupremeMedicalScreen4,
                    );
                  },
...
//                     context,
//                     CupertinoPageRoute(
//                       builder: (context) => CareSupremeMedicalScreen4(),
//                     ),
//                   );
//                 },
//                 child: Text('Next'),
