...
import '../../viewmodel/medical_4_viewmodel.dart';

class CareSupremeMedicalScreen4 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
      create: (context) => CareSupremeMedical4ViewModel(),
      child: Scaffold(
        appBar: AppBar(
        ...
        body: Consumer<CareSupremeMedical4ViewModel>(
              ...
              Expanded(
                child: ElevatedButton(
                  onPressed: () {
                    Navigator.pushNamed(
                      context,
                      RouteNames.careSupremeMedicalScreen5,
                    );
                  },
...
//                     context,
//                     CupertinoPageRoute(
//                       builder: (context) => CareSupremeMedicalScreen5(),
//                     ),
//                   );
//                 },
//                 child: Text('Next'),
