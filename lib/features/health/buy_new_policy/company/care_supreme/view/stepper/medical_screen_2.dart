...
import '../../viewmodel/medical_2_viewmodel.dart';

class CareSupremeMedicalScreen2 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
      create: (context) => CareSupremeMedical2ViewModel(),
      child: Scaffold(
        appBar: AppBar(
        ...
        body: Consumer<CareSupremeMedical2ViewModel>(
              ...
              Expanded(
                child: ElevatedButton(
                  onPressed: () {
                    Navigator.pushNamed(
                      context,
                      RouteNames.careSupremeMedicalScreen3,
                    );
                  },
                  child: Text(
                    'Next',
...
// import 'package:flutter/cupertino.dart';
// import 'package:flutter/material.dart';
// import 'package:insurance/features/health/buy_new_policy/company/care_supreme/view/stepper/medical_screen_3.dart';
// import 'package:provider/provider.dart';
...
//                     context,
//                     CupertinoPageRoute(
//                       builder: (context) => CareSupremeMedicalScreen3(),
//                     ),
//                   );
//                 },
//                 child: Text('Next'),
