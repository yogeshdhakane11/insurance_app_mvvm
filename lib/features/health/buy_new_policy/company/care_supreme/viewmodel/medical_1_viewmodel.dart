...
class CareSupremeMedical1ViewModel extends ChangeNotifier {
  // Controllers
  final TextEditingController textDescriptionController =
      TextEditingController();
  final TextEditingController ifYesExistingSinceController =
      TextEditingController();
  ...
  bool showError = false; // Flag to control error display for checkboxes
