...
import '../../viewmodel/stepper/medical_screen_6_viewmodel.dart';

class NivaMedicalScreen6 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
      create: (context) => MedicalScreen6Viewmodel(),
      child: Consumer<MedicalScreen6Viewmodel>(
                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'Has the Applicant ever been diagnosed or treated for any generic/hereditary disorders or HIV/AIDS?',
                            style: TextStyle(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  TextFormField(
                                    ...
                                    validator: (value) {
                                      if (value == null || value.isEmpty) {
                                        return 'Doctor\'s Details are required';
                                      }
                                      return null;
                                    },
                                  ),
...
// import 'package:flutter/material.dart';
// import 'package:provider/provider.dart';
// import '../../viewmodel/stepper/checkbox_viewmodel.dart';
// import '../../viewmodel/stepper/medical_screen_6_viewmodel.dart';
// import 'medical_screen_7.dart';
//
// class NivaMedicalScreen6 extends StatelessWidget {
//   @override
//   Widget build(BuildContext context) {
...
//                             context,
//                             CupertinoPageRoute(
//                               builder: (context) => NivaMedicalScreen7(),
//                             ),
//                           );
//                         }
//                       }
