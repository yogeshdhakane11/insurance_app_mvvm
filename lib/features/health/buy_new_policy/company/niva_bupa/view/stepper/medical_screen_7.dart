...
import '../../viewmodel/stepper/medical_screen_7_viewmodel.dart';

class NivaMedicalScreen7 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
      create: (context) => MedicalScreen7Viewmodel(),
      child: Consumer<MedicalScreen7Viewmodel>(
...
//                             context,
//                             CupertinoPageRoute(
//                               builder: (context) => NivaMedicalScreen8(),
//                             ),
//                           );
//                         }
//                       }
