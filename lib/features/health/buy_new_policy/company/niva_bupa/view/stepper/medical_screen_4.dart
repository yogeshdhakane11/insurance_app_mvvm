...
import '../../viewmodel/stepper/medical_screen_4_viewmodel.dart';
import 'medical_screen_5.dart';

class NivaMedicalScreen4 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
      create: (context) => MedicalScreen4Viewmodel(),
      child: Consumer<MedicalScreen4Viewmodel>(
                            ...
                            Form(
                              ...
                              child: Column(
                                ...
                                children: [
                                    ...
                                    children: [
                                      Row(
                                        children: [
                                          Radio<bool>(
                                            value: true,
                                            groupValue: viewModel.isInsulin,
                                            onChanged: (value) {
                                              viewModel.setInsulin(true);
                                            },
                                          ),
                                          Text(
                                            'Yes',
                                  ...
                                  TextFormField(
                                    controller: viewModel.hba1cController,
...
//                             context,
//                             CupertinoPageRoute(
//                               builder: (context) => NivaMedicalScreen5(),
//                             ),
//                           );
//                         }
//                       }
