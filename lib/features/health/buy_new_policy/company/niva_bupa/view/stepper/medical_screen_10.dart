...
import 'package:insurance/features/health/buy_new_policy/company/niva_bupa/viewmodel/stepper/medical_screen_10_viewmodel.dart';
import 'package:provider/provider.dart';
import '../../../../../../../routes/routes_name.dart';
import '../../../care_supreme/viewmodel/checkbox_viewmodel.dart';
import 'medical_screen_11.dart';

class NivaMedicalScreen10 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
      create: (context) => MedicalScreen10Viewmodel(),
      child: Consumer<MedicalScreen10Viewmodel>(
                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'Does any of the applicants takes alcohol',
                            style: TextStyle(
                            ...
                            Form(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'Please specify the consumption per week',
                                    style: TextStyle(
                                      fontSize: screenWidth * 0.04,
                                    ), // Responsive font size
                                  ),
                                  ...
                                  TextFormField(
                                    controller: viewModel.mlPerWeekController,
                                    keyboardType: TextInputType.number,
                                    decoration: InputDecoration(
                                      labelText: 'ml per week',
                                    ...
                                    children: [
                                      Expanded(
                                        child: CheckboxListTile(
                                          ...
                                          activeColor: Colors.blue,
                                          value: viewModel.isDailyDrinkerYes,
                                          onChanged: (value) {
                                            if (value != null) {
                                              viewModel.toggleDailyDrinkerYes(
                                                value,
                                              );
                                            }
                                          },
                                      ...
                                      Expanded(
                                        child: CheckboxListTile(
                                          ...
                                          controlAffinity:
                                              ListTileControlAffinity.leading,
                                          activeColor: Colors.blue,
                                          value: viewModel.isDailyDrinkerNo,
                                          onChanged: (value) {
                                            if (value != null) {
                                              viewModel.toggleDailyDrinkerNo(
                                                value,
                                              );
                                            }
                                          },
                      ...
                      onPressed: () {
                        ...
                        if (viewModel.isApplicableChecked) {
                          if (viewModel.formKey.currentState?.validate() ==
                            ...
                            Navigator.pushNamed(
                              context,
                              RouteNames.nivaMedicalScreen11,
                            );
                          }
...
//                               context,
//                               CupertinoPageRoute(
//                                 builder: (context) => NivaMedicalScreen11(),
//                               ),
//                             );
//                           }
//                         }
