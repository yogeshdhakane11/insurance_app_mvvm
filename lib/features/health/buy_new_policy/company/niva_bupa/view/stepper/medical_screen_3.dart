...
import '../../viewmodel/stepper/medical_screen_3_viewmodel.dart';

class NivaMedicalScreen3 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
      create: (context) => MedicalScreen3Viewmodel(),
      child: Consumer<MedicalScreen3Viewmodel>(
...
//                             context,
//                             CupertinoPageRoute(
//                               builder: (context) => NivaMedicalScreen4(),
//                             ),
//                           );
//                         }
//                       }
