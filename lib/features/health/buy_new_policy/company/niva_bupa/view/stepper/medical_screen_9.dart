...
import 'package:insurance/features/health/buy_new_policy/company/niva_bupa/viewmodel/stepper/medical_screen_9_viewmodel.dart';
import 'package:provider/provider.dart';
import '../../../../../../../routes/routes_name.dart';
import '../../../care_supreme/viewmodel/checkbox_viewmodel.dart';
import 'medical_screen_10.dart';

class NivaMedicalScreen9 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
      create: (context) => MedicalScreen9Viewmodel(),
      child: Consumer<MedicalScreen9Viewmodel>(
                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'Does any of the applicants Smokes Cigarettes / Bidi / Cigar',
                            style: TextStyle(
                            ...
                            Form(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  TextFormField(
                                    controller: viewModel.noPacketsController,
                                    keyboardType: TextInputType.number,
                                    decoration: InputDecoration(
                                      labelText: 'No. of packets',
                      ...
                      onPressed: () {
                        ...
                        if (viewModel.isApplicableChecked) {
                          if (viewModel.formKey.currentState?.validate() ==
                            ...
                            Navigator.pushNamed(
                              context,
                              RouteNames.nivaMedicalScreen10,
                            );
                          }
...
//                               context,
//                               CupertinoPageRoute(
//                                 builder: (context) => NivaMedicalScreen10(),
//                               ),
//                             );
//                           }
//                         }
