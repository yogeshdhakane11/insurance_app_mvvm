...
class MedicalScreen5Viewmodel extends ChangeNotifier {
  // Step 1 : Form key for validation
  final GlobalKey<FormState> formKey = GlobalKey<FormState>();

  // Step 2 : Create TextEditingControllers for each TextFormField
  final TextEditingController bpDystolicController = TextEditingController();
